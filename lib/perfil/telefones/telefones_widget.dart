              ...
              child: Column(
                ...
                children: [
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.apiResultspq = await PhoneIdCall.call(
                                    ...
                                    numero:
                                        '+55${_model.txtMesAnoTextController.text}${_model.textNumeroTextController.text}',
                                  ...
                                  if ((_model.apiResultspq?.succeeded ??
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text(
                                              'Por favor tente vincular a sua conta'),
                                          content: Text(
                                              'Seu token de autenticação deve ter expirado, por favor vincule a sua conta da GoTo novamente'),
                                          actions: [
                                            TextButton(
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<List<DDDNumbersRow>>(
                      future: (_model.requestCompleter ??=
                              Completer<List<DDDNumbersRow>>()
                                ..complete(DDDNumbersTable().queryRows(
                                  queryFn: (q) => q,
                                )))
                          .future,
                      builder: (context, snapshot) {
                        ...
                        List<DDDNumbersRow> listViewDDDNumbersRowList =
                            snapshot.data!;
                        ...
                        return ListView.builder(
                          ...
                          itemCount: listViewDDDNumbersRowList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewDDDNumbersRow =
                                listViewDDDNumbersRowList[listViewIndex];
                            return Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      valueOrDefault<String>(
                                        listViewDDDNumbersRow.phoneNumber,
                                        'Erro',
                                      ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            await DDDNumbersTable().delete(
                                              matchingRows: (rows) =>
                                                  rows.eqOrNull(
                                                'id',
                                                listViewDDDNumbersRow.id,
                                              ),
                                            );
                                          },
                                          child: Icon(
