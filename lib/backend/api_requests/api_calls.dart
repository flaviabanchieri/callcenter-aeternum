...
class ProximoLeadCall {
  ...
  static String? plataforma(dynamic response) =>
      castToType<String>(getJsonField(
        response,
        r'''$.plataforma''',
      ));
...
class ObterPainelCardsCall {
  ...
  static double? faturado(dynamic response) => castToType<double>(getJsonField(
        response,
        r'''$[:].fautrado''',
      ));
...
class GetDdNumbersCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      callName: 'get dd numbers',
      apiUrl:
          'ttps://glkamikbytidbcuakgcc.supabase.co/rest/v1/rpc/get_all_ddd_numbers',
      callType: ApiCallType.POST,
      headers: {
        'Content-Type': 'application/json',
        'apikey':
