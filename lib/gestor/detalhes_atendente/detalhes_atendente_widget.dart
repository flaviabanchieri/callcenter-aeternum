  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.nome = valueOrDefault<String>(
        _model.supabaseAtendente?.firstOrNull?.nome,
        'Nome',
      );
      _model.email = valueOrDefault<String>(
        _model.supabaseAtendente?.firstOrNull?.email,
        'Email',
      );
      _model.img = valueOrDefault<String>(
        _model.supabaseAtendente?.firstOrNull?.foto,
        'Nome',
      );
      _model.codigo = valueOrDefault<String>(
        _model.supabaseAtendente?.firstOrNull?.codigoPayt,
        'Sem código',
      );
      _model.pontoLista =
